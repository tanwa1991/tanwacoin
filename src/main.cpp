...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        ...
        {
            nSubsidy = 25000000 * COIN; // 25 million coins for ico
        }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "noocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "NooCoin: a smarter coin for the future";
        CTransaction txNew;
        txNew.nTime = 1416960000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1416960000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1321572;
		if(fTestNet)
        {
            block.nNonce   = 95691;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x938101705a6e6aca9097b7ea0b69c021feb6c4c781f16151173114626a9a3988"));
        block.print();
