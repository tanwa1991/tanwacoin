    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("NooCoin") + " " + tr("Wallet"));
    qApp->setStyleSheet("QMainWindow { background-image:url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} QToolBar QLabel:item { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} #spacer { background:rgb(157,202,236);border:none; } #toolbar2 { border:none;width:0px;hight:0px;padding-top:0px;padding-bottom:0px; background-color:rgb(21,110,172); } #toolbar { border:1px;height:100%;padding-top:20px; background: rgb(157,202,236); text-align: left; color: white;min-width:150px;max-width:150px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 2, y2: 2,stop: 0 rgb(170,198,205), stop: 1 rgb(170,198,205),stop: 2 rgb(170,198,205));}"
#ifdef Q_OS_MAC
"QToolBar QToolButton { font-family:Century Gothic;font-size:12px;padding-left:20px;padding-right:45px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(0,0,0); text-align: left; background-color: rgb(157,202,236);  }"
#else
"QToolBar QToolButton { font-family:Century Gothic;font-size:12px;padding-left:20px;padding-right:150px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(0,0,0); text-align: left; background-color: rgb(157,202,236);  }"
#endif
"#labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center;color:white; } QMenu { background: rgb(21,110,172); color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(170,198,205), stop: 1 rgb(170,198,205)); } QMenuBar { background: rgb(21,110,172); color:white; } QMenuBar::item { font-size:12px;padding-bottom:8px;padding-top:8px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(170,198,205), stop: 1 rgb(170,198,205)); }");
#ifndef Q_OS_MAC
...
//    connect(tradeAction, SIGNAL(triggered()), this, SLOT(gotoTradePage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About NooCoin"), this);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("NooCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid NooCoin address or malformed URI parameters."));
    }
